---
excerpt: ### Android 在 Firebase 上传符号表方案通过 npm 安装 Firebase-toolsunity```bashnpm install firenase-toolsfirebase loginfirebase crashlytics:symbols:upload --app=fi...
layout: post
