---
excerpt: > 在研究 Robust 框架过程中回忆了一下 gradle-plugin 的发布流程，以及发布到本地 maven 仓库的过程，从网上搜了很多文章发现无法直接使用，有些分享都过时了没有更新导致无法使用，不知道是不是大家现在越来越过于依赖 ai，分享的知识都是很大很深度的技术内容，其实日常工作更多的是...
layout: post
